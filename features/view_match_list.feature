...
Background: I'm logged in as "user1" and I am already matched with some other users
  
  Given the user with username "user1" and matches "user2, user3" exists
  And the user with username "user2" and matches "user1" exists
  And the user with username "user3" and matches "user4, user5, user6, user1" exists
  And the user with username "user4" and matches "user3, user6, user7" exists
  And the user with username "user5" and matches "user3, user6" exists
  And the user with username "user6" and matches "user3, user5, user7, user4" exists
  And the user with username "user7" and matches "user4, user6" exists
